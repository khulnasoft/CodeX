...
readonly DESCRIPTION=$(
  ...
  This script downloads and installs the latest codex binary.
EOF
)
readonly DOCS_URL="https://github.com/khulnasoft/codex"
readonly COMMUNITY_URL="https://discord.gg/khulnasoft"
