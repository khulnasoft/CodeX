...
let
  ...
  */
  pkgs = import
    ...
    {
      config = {
        # Always include unfree or broken packages in the index. Codex can choose
  ...
  getPkgInfo = drv: {
    ...
    */
    ...
    /* The package version split into a list of its components. The version is
       split using the splitVersion built-in function so that Codex can do
       ordered comparisons.
