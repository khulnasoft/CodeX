...
func TestOpen(t *testing.T) {
	...
	t.Run("File", func(t *testing.T) {
		...
		path := filepath.Join(root, "codex.json")
...
func TestFind(t *testing.T) {
	...
	t.Run("IgnoreDirsWithMatchingName", func(t *testing.T) {
		...
		trickyDir := filepath.Join(child, "codex.json")
		...
		if errors.Is(err, errIsDirectory) {
			t.Fatalf("Find(%q) did not ignore a directory named codex.json: %v", child, err)
		}
		if err != nil {
			t.Fatalf("Find(%q) error: %v", child, err)
		}
...
func TestFindError(t *testing.T) {
	...
	t.Run("Permissions", func(t *testing.T) {
		...
		path := filepath.Join(child, "codex.json")
