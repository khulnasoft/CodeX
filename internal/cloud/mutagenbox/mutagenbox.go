...
const (
	...
	dataDirPath = ".config/codex/mutagen"
)

// TerminateSessionsForMachine is a codex-specific API that calls the generic mutagen terminate API.
...
// createAndGetDataDir prepares the data directory for codex's mutagen instance
