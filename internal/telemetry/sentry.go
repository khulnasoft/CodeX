...
func splitPkgFunc(name string) (pkgPath, funcName string) {
	...
	// github.com/khulnasoft/codex/internal/codex.(*Codex).RunScript

	// dir = github.com/khulnasoft/codex/internal/
	// base = codex.(*Codex).RunScript
	...
	// pkgPath = github.com/khulnasoft/codex/internal/codex
	// funcName = (*Codex).RunScript
