...
The Nixhub API lets you search over 1 million package versions for over 100,000 Nix packages. You can use the Nixhub API to search for packages, resolve historic versions, and then install them using Codex or Nix. Nixhub is designed to be simple and easy to use, and is free to use for personal use. 
